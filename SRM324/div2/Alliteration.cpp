...
class Alliteration {
    ...
    int count(vector <string> words) {
		...
		char pre = 'X';
		rep(i, n - 1) {
			if(words[i][0] != pre && words[i][0] == words[i+1][0]) ans++;
			pre = words[i][0];
		}
...
int main() {
	...
	cout << ___test.count({"b", "B", "c", "C", "d", "D", "e", "E", "f", "F", "g", "G", "h", "H", "i", "I", "j", "J", "k", "K", "l", "L", "m", "M", "n", "N", "o", "O", "p", "P", "q", "Q", "r", "R", "s", "S", "t", "T", "u", "U", "v", "V", "w", "W", "x", "X", "y", "Y", "z", "Z"}) << endl;
}
